...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        context = f"Planning a trip to {city} from {travel_dates} based on interests: {interests}."
        return Task(
            description=dedent(
                f"""
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        context = f"Identifying the best city from {cities} for a trip starting from {origin} on {travel_dates}."
        return Task(
            description=dedent(
                f"""
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        context = f"Gathering detailed information about {city} for a trip on {travel_dates} with interests: {interests}."
        return Task(
            description=dedent(
                f"""
